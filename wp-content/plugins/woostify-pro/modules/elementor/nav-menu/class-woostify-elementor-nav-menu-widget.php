	...
	public function parent_menu() {
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .woostify-nav-menu-widget .primary-navigation > li.menu-item > a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'separator'          => 'after',
				'selectors'          => array(
					'{{WRAPPER}} .woostify-nav-menu-widget .primary-navigation > li.menu-item > a' => 'margin: 0px {{RIGHT}}{{UNIT}} 0px {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} #menu-primary-menu > li > a' => 'border-width: {{SIZE}}{{UNIT}};',
				),
				'separator'  => 'before',
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .sidebar-menu-bottom ul > li > a'                => 'color: {{VALUE}};',
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .sidebar-menu-bottom ul > li > a'  => 'background-color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .sidebar-menu-bottom ul > li > a' => 'border-color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .sidebar-menu-bottom ul > li > a:hover'                        => 'color: {{VALUE}};',
					'{{WRAPPER}} .sidebar-menu-bottom ul > li.menu-item-has-children:hover > a' => 'color: {{VALUE}};',
					'{{WRAPPER}} .sidebar-menu-bottom ul > li > a:hover .woostify-svg-icon'     => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .sidebar-menu-bottom ul > li > a:hover'                        => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .sidebar-menu-bottom ul > li.menu-item-has-children:hover > a' => 'background-color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .sidebar-menu-bottom ul > li > a:hover'                        => 'border-color: {{VALUE}};',
					'{{WRAPPER}} .sidebar-menu-bottom ul > li.menu-item-has-children:hover > a' => 'border-color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .sidebar-menu-bottom ul > li.current-menu-item > a'        => 'color: {{VALUE}};',
					'{{WRAPPER}} .sidebar-menu-bottom ul > li.current-menu-ancestor > a'    => 'color: {{VALUE}};',
					'{{WRAPPER}} .sidebar-menu-bottom ul > li.current-menu-parent > a'      => 'color: {{VALUE}};',
					'{{WRAPPER}} .sidebar-menu-bottom ul > li.current_page_parent > a'      => 'color: {{VALUE}};',
					'{{WRAPPER}} .sidebar-menu-bottom ul > li.current_page_ancestor > a'    => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .sidebar-menu-bottom  ul a' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .sidebar-menu-bottom ul a' => 'background-color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .sidebar-menu-bottom ul a' => 'border-color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .sidebar-menu-bottom ul a:hover' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .sidebar-menu-bottom ul a:hover' => 'background-color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .sidebar-menu-bottom ul a:hover' => 'border-color: {{VALUE}};',
				),
			)
		);
...
Plugin::instance()->widgets_manager->register( new Woostify_Elementor_Nav_Menu_Widget() );
