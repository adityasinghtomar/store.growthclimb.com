  ...
  *
	...
	public static function get_general_settings()
	{
		$default_settings = apply_filters(
			...
			[
				...
				'order_bump' => 'off',
				'ab_testing' => 'off',
				'allow_funnels' => ['administrator' => 'true'],
				'funnel_type' => 'lead',
	...
	*/
    ...
    public static function generate_first_step( $funnel_id, $steps = [] ) {
        if( $funnel_id ) {
            ...
            $priority_order = [ 'landing', 'custom', 'checkout', 'upsell', 'downsell', 'thankyou' ];
	...
	*/
	...
	private static function is_elementor_edit_page() {
		...
		return 'elementor' === filter_input( INPUT_GET, 'action', FILTER_SANITIZE_SPECIAL_CHARS ) || filter_input( INPUT_GET, 'elementor-preview', FILTER_SANITIZE_STRING );
	}
	...
	private static function is_oxygen_edit_page() {
		...
		return wp_script_is( 'ct-automation' ) || wp_style_is( 'ct-select2' ) || 'ct_render_shortcode' === filter_input( INPUT_GET, 'action', FILTER_SANITIZE_SPECIAL_CHARS ) || filter_input( INPUT_GET, 'ct_builder', FILTER_SANITIZE_STRING ) || filter_input( INPUT_GET, 'ct_inner', FILTER_SANITIZE_STRING );
	}
	...
	public static function get_text(){
		return [
			...
			'set_variation_as_winner' => __('If you set this variationa as a winner','wpfnl'),
			...
			'click_to_update_image' => __('Click to Upload an Image','wpfnl'),
	...
	public static function maybe_bricks_theme(){
		return 'Bricks' === wp_get_theme()->get( 'Name' );
	}
