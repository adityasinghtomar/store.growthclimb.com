...
<div class="wpfnl-reset wpfnl-order-bump__template-style2" style="background-color: <?php echo $orderbump_bgcolor; ?>">
    ...
    <div class="template-preview-wrapper">
        ...
        <div class="template-content">
            ...
            <div class="description" style="color: <?php echo $ob_description_color ?>" ><?php echo $settings['productDescriptionText'] ?></div>
        </div>
    </div>
    ...
    <style>
        ...
        .wpfnl-order-bump__template-style2 .template-preview-wrapper .description p {
            color: <?php echo $ob_description_color ?>
        }
