            ...
            <div class="template-title-area">
                ...
                <div class="offer-checkbox">
                    <span class="wpfnl-checkbox">
                        ...
                        <label for="wpfnl-order-bump-cb-<?php echo $key ?>" style="color: <?php echo $orderbump_color; ?>" >Add</label>
                    </span>
                </div>
            </div>
            
            <div class="description" style="color: <?php echo $ob_description_color ?>" >
