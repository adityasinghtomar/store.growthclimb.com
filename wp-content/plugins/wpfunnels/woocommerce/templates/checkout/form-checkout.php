<?php
$checkout_layout = '';
if( \WPFunnels\Wpfnl_functions::is_wpfnl_pro_activated() && isset( $_SESSION[ 'checkout_layout' ] ) && 'wpfnl-express-checkout' === $_SESSION[ 'checkout_layout' ] ) {
...
} else if( \WPFunnels\Wpfnl_functions::is_wpfnl_pro_activated() && isset( $_SESSION[ 'checkout_layout' ] ) && 'wpfnl-2-step' === $_SESSION[ 'checkout_layout' ] ) {
	$checkout_layout = $_SESSION[ 'checkout_layout' ];
	unset( $_SESSION[ 'checkout_layout' ] );
